...
class FixedPointsForPtolemy {
  ...
  /// and the 3 points of an equilateral triangle prescribed by the same circle.
  ...
  /// [refTrianglePt1], [refTrianglePt2] and [refTrianglePt3] are the 3 point on an equilateral triangle prescribed by a
